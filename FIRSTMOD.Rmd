...
# MAR: marrige status
research_data <- wa_data[c('SERIALNO','SPORDER','SEX', 'CIT','PERNP','SCHL','RAC1P','ESR', 'MAR', 'WKHP')]
...
# Columns name change
colnames(new)
new <- new[c("SERIALNO", "SPORDER","SEX", "CIT", "PERNP", "RAC1P", "ESR", "MAR", "EducLevel",  "WKHP")]
colnames(new) <- c("Housing_Unit","Person_Number", "Sex", "Citizenship", "Total_Person_Earning", "Race", "Employment_status", "Marrige", "EducLevel", "Work_hour" )
View(new)
...
# Data modeling
```{r}
mod <- lm(Total_Person_Earning ~ EducLevel + Sex + Citizenship + Race + Marrige + Employment_status, data = new)
summary(mod)
```
