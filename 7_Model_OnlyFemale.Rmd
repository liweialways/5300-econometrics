...
# exclude male
new <- new[new['SEX'] == 2, ]
# exclude the columns work hours, self-care difficulty and disability, gender
...
# 9 .Two or More Races
race_wa <- ggplot(new, aes(x = RaceAndEthnic)) + geom_histogram(stat = "count") + labs(title = "Race in WA")
race_wa
```
